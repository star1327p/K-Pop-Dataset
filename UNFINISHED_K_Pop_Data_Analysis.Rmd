...
e.g. Lee Si An (李詩安) and Yoo Ji Na (柳知娜) started out as complete beginners in the show, but they picked up the K-pop dance very fast and survived untill the final episode.   
...
Explain the `gridExtra` package.  

```{r idol-scores-scatter-plot-drafts, fig.height=2, fig.width=6.5, fig.cap="Test scatterplots, from left to right"}
