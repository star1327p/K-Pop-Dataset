...
To become a K-Pop idol in Korea, aspiring kids usually start as a trainee at an entertainment company in their early teens. (citation needed)   

vocal and dance lessons  
Intense competition   
Very few trainees can eventually get selected to debut and perform on stage as the company's official group.  
...
# Combine all three summary tables into one data.frame

print("Summary Statistics")
print("Vocal:")
print(summary(idol_school$Vocal))
print("Dance:")
print(summary(idol_school$Dance))
print("Physical:")
print(summary(idol_school$Physical))
```
