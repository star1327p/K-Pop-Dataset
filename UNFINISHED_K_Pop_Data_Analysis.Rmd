...
# UNFINISHED HERE
# Do we need to add a snapshot of the long_data?
# Consider but unsure: 
# Separate this code chunk into tidyr and ggplot2.
...
```{r idol-scores-scatter-plot-drafts, fig.height=2, fig.width=6.5, fig.cap="Scatterplots to show the pairwise correlation between the vocal, dance, and physical scores. The graphs from left to right are: Vocal vs Dance, Vocal vs Physical, and Dance vs Physical."}

# UNFINISHED HERE

# To-Do:
# 1. Set the x-ticks and y-ticks to c(0, 2.5, 5, 7.5, 10)
# 2. Change the colors and/or shapes of the points (optional)
# 3. Write an appropriate figure caption
