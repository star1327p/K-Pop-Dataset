...
What about the median score of vocal?   
...
Physical has the lowest median score (3.25) among all three categories.   
...
We suspect that the individual exercise accounted for a larger proportion of the physical score. We saw in the video that Lee Da Hee (李多熙) and Kim Na Yeon (金娜妍) came in first in the group physical exercise. However, Da Hee's physical score was only 4.9, and Na Yeon got 6.4 (which is good but not one of the best).^[Screenshot of the first place team in the group physical exercise: <https://bit.ly/3EDBhz5>]    
...
Both random forests and SVM^[SVM stands for Support Vector Machine. <https://en.wikipedia.org/wiki/Support_vector_machine>] predicted Lee Hae In (李海印) to be in the top 9 for the debut, but Hae In ended up in an unexpected 11th place. K-pop fans crowdsourced to count the votes for Hae In, and the number of confirmed votes was already higher the the number of votes published by Mnet. (Note that the number of confirmed votes is a subset of all actual votes.) This raised suspicion that the *Idol School* results may have been rigged.^[<https://star.ettoday.net/news/1022482>]     
