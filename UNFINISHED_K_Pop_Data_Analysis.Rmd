...
The training at a K-Pop entertainment company in Korea usually includes vocal and dance lessons \cite{padget2017difficulties}, so it is reasonable to see a high correlation between vocal and dance scores.   


Theoretically dance and physical should be highly correlated \cite{dance2024strength}.  

Why is the correlation lower between dance and physical scores?   

Physical strength is essential to dancing, but dance also includes other critical elements such as technique and aesthetic expression \cite{geukes2023mirror}.   
